...
class _PerformanceAlertRuleScreenState extends State<PerformanceAlertRuleScreen>
  ...
  Widget build(BuildContext context) {
    ...
    // ✅ ADD — poore screen ko "view" permission se protect kiya. Agar
    // permission nahi hai to "Access Nahi Hai" screen dikhega, crash nahi hoga.
    return PermissionScreenGate(
      moduleId: 'performanceAlertRule',
      action: 'view',
      child: Scaffold(
        ...
        body: _loading
            ...
            : ListView(
                ...
                children: [
                  ...
                  if (!isFlat) ...[
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        PermissionGate(
                          // ✅ ADD — sirf allowed user ko hi "Add" button dikhega
                          moduleId: 'performanceAlertRule',
                          action: 'add',
                        ...
                        (o) => Container(
                          ...
                          child: Row(
                            children: [
                              ...
                              PermissionGate(
                                // ✅ ADD — sirf allowed user ko hi delete button dikhega
                                moduleId: 'performanceAlertRule',
                                action: 'delete',
                                child: IconButton(
                                  icon: const Icon(
                  ...
                  PermissionGate(
                    // ✅ ADD — sirf allowed user ko hi Save (edit) button dikhega
                    moduleId: 'performanceAlertRule',
                    action: 'edit',
                    child: SizedBox(
                      width: double.infinity,
